            ...
            <div className="q__wrapper">
                ...
                <div className="choice__wrapper">
                    <div className="option">
                        <input type="checkbox" value="Mobile Money (MoMo)" id="MoMo" name="payment"/>
                        <label for="MoMo">Mobile Money (MoMo)</label>
                    </div>
                    <div className="option">
                        <input type="checkbox" value="Bank Account" id="bank" name="payment"/>
                        <label for="bank">Bank Account</label>
                    </div>
                    <div className="option">
                        <input type="checkbox" value="Physical Cash" id="cash" name="payment"/>
